...
class MESA_Isochrones:
    ...
    def read_iso_file(self):
        ...
        def num_line(cols): return fread('(1x,i4,{:d}i32)'.format(int(cols-1)))
        def col_line(cols): return fread('(2x,a3,{:d}a32)'.format(int(cols-1)))
        def data_line(cols): return fread('(i5,{:d}e32.16)'.format(int(cols-1)))
